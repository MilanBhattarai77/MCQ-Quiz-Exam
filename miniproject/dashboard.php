...
?>
        ...
        xmlhttp.open("GET","session/load_total_que.php",true);
        xmlhttp.send(null);
        ...
        xmlhttp.open("GET","session/load_questions.php?questionno="+ questionno,true);
        xmlhttp.send(null);
			}
        ...
        xmlhttp.open("GET","session/save_answer.php?questionno="+ questionno+"&value1="+radiovalue,true);
        xmlhttp.send(null);
			}
